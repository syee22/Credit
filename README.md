...
## 신용카드 사용자의 신용등급을 분류 예측하는 알고리즘
# 알고리즘 별로 변수들의 전처리를 다양하게 적용하여 성능을 비교한 결과
# GBM
...
이때 정확도 기준으로 아래와 같은 모델이 최고성능을 보였다고 할 수 있다.
...
성능이 가장 좋았다.
<img width="475" alt="로그로스기준" src="https://user-images.githubusercontent.com/108845232/195586287-f0e9c548-a145-45b5-9b72-539db75f17af.png">
